...
const projects = [
  {
    title: "DistroScale",
    description: "A multi-tenant SaaS platform for supply chain distribution management, serving 500+ merchants with real-time inventory and order tracking.",
  ...
  {
    title: "AuthKit",
    description: "Open source authentication library supporting OAuth2, JWT, and magic links for Node.js backends. 2k+ GitHub stars.",
  ...
  {
    title: "MentorFlow",
    description: "A booking and mentorship platform connecting software engineers with senior mentors for 1-on-1 sessions and career tracking.",
  ...
  },
  {
    ...
    description: "An interactive system design learning platform with real-world scenarios, diagrams, and interview preparation modules.",
  ...
  {
    title: "AgriConnect",
    description: "A mobile-first platform connecting rural farmers to markets and financial services. Finalist at MEST Africa Challenge.",
  ...
  {
    title: "DevMetrics",
    description: "A developer productivity dashboard aggregating GitHub, Jira, and Linear data into actionable engineering metrics.",
